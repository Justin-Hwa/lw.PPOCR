...
These constants describe the exact external Small validation assets currently
used by the analysis tools.  They do not promote Small to a released model;
they make every experimental conversion fail closed when the source contract
changes.
"""
